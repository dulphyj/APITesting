...
public class Item {
     ...
     * @param collapsed
     * @param dueDate
     * @param lastSyncedDateTime
     * @param ownerId
     * @param content
     * @param dateStringPriority
     ...
     * @param id
     * @param inHistory
     * @param dueTimeSpecified
     * @param dateString
     * @param syncClientCreationId
     * @param priority
     * @param parentId
     * @param recurrence
     ...
     * @param projectId
     */
    public Item(Integer id, String content, Integer itemType, Boolean checked, Object projectId, Object parentId, String path, Boolean collapsed, String dateString, Integer dateStringPriority, String dueDate, Object recurrence, Integer itemOrder, Integer priority, String lastSyncedDateTime, List<Object> children, String dueDateTime, String createdDate, Object lastCheckedDate, String lastUpdatedDate, Boolean deleted, String notes, Boolean inHistory, Object syncClientCreationId, Boolean dueTimeSpecified, Integer ownerId) {
        super();
        this.id = id;
